# Laboration 3, del 2
Denna webbplats är skapad för kursen Backend-baserad webbutveckling vid Mittuniversitetet.
...
- Lösningen är skapad med HTML, CSS och JavaScript.
- Lösningen är publicerad till publikt tillgänglig webbhost.
